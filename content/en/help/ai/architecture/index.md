...
AGPL-3.0-or-later for all subprojects. Source available on
request — the Forgejo repositories are not publicly accessible;
access is granted once your SSH public key has been enabled.
